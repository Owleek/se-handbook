    ...
    <React.Fragment>
      <Note title='useState'>
        <NoteItem>
          ...
          <p>
            Если мы в set передадим аргумент, то react увеличит значение и
            сравнит с текущим стейтом, если стейт уже соответсвтует вычисленному
            значению, операция применяться не будет
          </p>
          <p>
            Но если мы используем колбек при set, мы в аргументе коллбека
            получаем актуальное значение state с учетом выполненных подсчетов
            очреди, и по этому постоянный инкремент будет всегда больше
            актуального стейта
          </p>
          <br />
          <p>
      ...
      <Note title='useReducer'>
        <NoteItem>
          ...
          <br />
          <p>
            reducer должен быть чистой функцией без побочных эффектов которая
            явно возвращает state, поскольку react рассчитывает именно на это и
            ни на что другое
          </p>
          <br />
          <p>
